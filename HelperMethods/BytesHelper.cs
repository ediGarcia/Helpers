...
public static class BytesHelper
{
    ...
    private static readonly IReadOnlyDictionary<FileSizeUnit, double> BinaryMultipliers =
        new Dictionary<FileSizeUnit, double>
        {
            { FileSizeUnit.Byte, 1 },
    ...
    private static readonly IReadOnlyDictionary<FileSizeUnit, double> DecimalMultipliers =
        new Dictionary<FileSizeUnit, double>
        {
            { FileSizeUnit.Byte, 1 },
