...
public static class StringExtensions
{
    ...
    /// <returns></returns>
    public static string Append(this string st, string value) => String.Concat(st, value);
    #endregion
    ...
    #region Count(this string, params string[])
    public static int Count(this string st, params string[] values) =>
        st.Split(values, StringSplitOptions.None).Length - 1;
    #endregion

    #region Count(this string, params char[])
    public static int Count(this string st, params char[] values) =>
        st.Length > values.Length ? st.Count(values.Contains) : values.Count(st.Contains);
    #endregion
    ...
    /// <param name="value"></param>
    /// <returns></returns>
    public static string Prepend(this string st, string value) => String.Concat(value, st);
    #endregion
    ...
    public static double ToDouble(this string st) => Double.Parse(st);
    #endregion
    ...
    /// <exception cref="FormatException"></exception>
    /// <exception cref="OverflowException"></exception>
    public static int ToInt(this string st) => Int32.Parse(st);
    #endregion
